...
This is the fall variation! Eat flies and avoid the birds. Hide underwater to heal and hide from the flashlights. 
...
> - This projects uses the code from (https://editor.p5js.org/maryamalmatrooshi/sketches/8tY74Enmr) for the leaves
